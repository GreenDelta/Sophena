...
public class BuildingStateEditor extends Editor {
	...
	private class Page extends FormPage {
		...
		FormToolkit toolkit) {
			...
			TableViewer table = Tables.createViewer(comp,"Bauweise", "Index",
		...
		implements ITableLabelProvider {
			...
			public Image getColumnImage(Object element, int col) {
				return col == 0 ? Images.BUILDING_TYPE_16.img() : null;
			}
			...
			public String getColumnText(Object element, int col) {
				...
				switch (col) {
				case 0:	return buildingState.name;
				case 1:	return getIndex(buildingState);
				case 2:	return getIsdefault(buildingState);
				case 3:	return getTypeLabel(buildingState);
				case 4:	return getHeatingLimit(buildingState);
				case 5:	return getWaterFraction(buildingState);
				case 6:	return getLoadHours(buildingState);
				default:return null;
				}
