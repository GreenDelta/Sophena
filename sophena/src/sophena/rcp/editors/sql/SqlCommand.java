...
class SqlCommand {
	...
	public String exec(String sqlStatement, Database database) {
	...
	private String runSelect(Database database, String query) {
	...
	private String runUpdate(Database database, String stmt) {
