...
public class HeatPumpCalcState {
	...
	private double calcTQ(int hour) {
		return switch (producer.heatPumpMode) {
			case OUTODOOR_TEMPERATURE_MODE -> Temperature.of(project, hour);
			case USER_TEMPERATURE_MODE -> producer.sourceTemperatureUser;
			case HOURLY_TEMPERATURE_MODE -> producer.sourceTemperatureHourly[hour];
		};
	}
